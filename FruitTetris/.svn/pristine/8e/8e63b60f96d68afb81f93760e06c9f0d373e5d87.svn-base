...
double 	timer	=  5; 		// keeps track of time
double 	drop_time = 8;
int	score = 0;
...
GLfloat alphaDown = 0.05f;

vector<vec2> toRemove;
vector<vec2> toGravity;
...
int rotation = 0;
bool released = false; // keep track if tile was released
